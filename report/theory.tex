...
The analog circuit has input signals delivered by the digital circuitry, and delivers its output to two ADCs. The analog circuit diagram is given in figure XXX, where each of the four pixel block has the circuit given in figure XXX.

% insert analog circuit here
% insert pixel circuit here
